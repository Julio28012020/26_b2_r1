...
![Configuración Base de Datos - URL y Usuario (sin contraseña)](TABLE.png)
...
![Log de Conexión Exitosa en Spring Boot](log-de-conexion-exitosa-en-spring-boot.png)
...
### [GET] Obtener por ID
![GET by ID](GET-ID.png)

### [GET] Obtener por Email
![GET by Email](GET-Email.png)
